...
class DeviceManufacturer(object):
    def __init__(self):
        ...
        self.create_required_fields = ["name", "location", "email", "password", "devices"]
        self.create_optional_fields = []

        self.update_required_fields = ["name", "location", "email", "password", "devices"]
        self.update_optional_fields = []

    def create(self, device_manufacturer):
        self.validator.validate(
            device_manufacturer, self.fields, self.create_required_fields, self.create_optional_fields)
    ...
    def update(self, device_manufacturer_id, device_manufacturer):
        self.validator.validate(
            device_manufacturer, self.fields, self.update_required_fields, self.update_optional_fields)
