...
class Device(object):
    def __init__(self):
        ...
        self.create_required_fields = ["device_id", "device_type", "device_name", "device_model", "device_manufacturer_id", "device_class"]
        self.create_optional_fields = []

        self.update_required_fields = ["device_id", "device_type", "device_name", "device_model", "device_manufacturer_id", "device_class"]
        self.update_optional_fields = []

    def create(self, device):
        self.validator.validate(
            device, self.fields, self.create_required_fields, self.create_optional_fields)
    ...
    def update(self, device_id, device):
        self.validator.validate(
            device, self.fields, self.update_required_fields, self.update_optional_fields)
